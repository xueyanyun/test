...
//		
////		String string="";
////		String[] fieStrings = string.split("\\|",-1);
////		System.out.print(fieStrings.length);
//		
//		
//		String teString = "你好";
//		System.out.println(isChineseChar(teString));
//				
//		
//		
//				
...
public class HeapSortUtil {
    ...
    private void buildHeap(int location,int unSortLength,int[] arr){
        ...
        int tempLoc;
        //判断该父节点是否有左右孩子
        if((tempLoc = (location + 1) * 2) < unSortLength){//既有左孩子又有右孩子
...
//        }
        ...
        int topArr[] = h.getTopArray(arr, 3);
        //打印出排序后的数组
